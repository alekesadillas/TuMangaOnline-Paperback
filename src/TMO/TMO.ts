...
const SOURCE_DOMAIN = "https://visortmo.com/"

export class TMO extends Source {
    constructor(cheerio: CheerioAPI) {
        super(cheerio)
    }

    get version(): string { return '0.1.0' }
    get name(): string { return 'TMO' }
    get description(): string { return 'Repositorio NO Oficial de TMO par Paperback' }
    get author(): string { return 'alekesadillas' }
